...
var CardReader = function (error_start, track_start, track_end, timeout) {
	this.error_start = error_start || "Ž";
...
CardReader.prototype = {
    ...
    //If we haven't started and the letter is the start char
		...
		//If we have started and this is the end char
		...
		//If we have started and finished and enter is pressed
